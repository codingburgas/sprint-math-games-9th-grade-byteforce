...
vector<CrosswordEntryEasy2> crossword = {
...
void crosswordEasy2() {
    ...
    for (const auto& entry : crossword) {
        ...
        if (checkGuessEasy2(entry.number, guess)) {
            cout << "Correct!\n";
            correctAnswers++;
            updateCrosswordEasy2(entry.number, entry.answer); // Update crossword layout
        }
        else {
